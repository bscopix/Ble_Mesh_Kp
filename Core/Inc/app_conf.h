 ...
 */
#define CFG_GAP_DEVICE_NAME             "KP_Mesh"
 ...
 */
/* Keep MTU at 23 for PB-GATT interoperability with tested phone provisioner (PROV_PUBLIC_KEY path). */
...
typedef enum
{
  ...
  CFG_TASK_MESH_LPN_REQ_ID,
	...
	CFG_TASK_RAW_NOTIFICATION_ID,
	CFG_TASK_SHOT_NOTIFICATION_ID,
	CFG_TASK_TARGET_NOTIFICATION_ID,

...
#if !defined(NUCLEO_L152RE) && !defined(USE_STM32WBXX_NUCLEO) && !defined(USE_STM32WBXX_USB_DONGLE) && !defined(BLUENRG1) && !defined(BLUENRG2)
#define USE_STM32WBXX_NUCLEO
#endif

#if defined(NUCLEO_L152RE) || defined(USE_STM32WBXX_NUCLEO) || defined(USE_STM32WBXX_USB_DONGLE) /* NUCLEO_L152RE */
#include "user_if.h" 
